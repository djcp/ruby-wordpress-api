...
1. Install the gem using specific_install
...
To make further requests, check out the documentation - this blog should follow the exact format of the [WordPress XML RPC API](http://codex.wordpress.org/XML-RPC_WordPress_API).
